...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'btn-base': 'cmw-font-secondary cmw-flex cmw-items-center cmw-justify-center cmw-text-sm\n'
    ...
    'btn-text': 'cmw-border-transparent cmw-text-primary-400 cmw-text-sm hover:(cmw-text-primary cmw-no-underline)',
  },
  alias: {
