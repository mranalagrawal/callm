...
export default {
  ...
  head: {
    ...
    winery: {
      title: 'Producteurs de vin et de champagne : toutes les caves de Callmewine',
      description: 'Desc: Découvrez les caves et les producteurs de vin sélectionnés par Callmewine : nous proposons des vins provenant des meilleurs domaines italiens et d\'ailleurs. Achetez en ligne dès maintenant!',
    },
  },
  enums: {
    ...enums.Accessibility,
  ...
  shipping: {
    ...
    cost: 'Les <strong>frais d\'expédition</strong> seront ajoutés à la caisse, après avoir choisi la méthode.',
    threshold: {
      info: 'Livraison gratuite à partir de {amount}',
      reached: 'Vous bénéficiez d\'une livraison gratuite',
      remaining: 'Il vous manque {amount} pour obtenir la livraison gratuite',
      progressBarReached: 'Vous bénéficiez d\'une livraison gratuite',
    },
  },
  home: 'Maison',
  ...
  eventGiftNote: 'Félicitations, vous avez droit à ce cadeau!',
  eventGiftFree: 'GRATUIT',
  eventProductExpired: 'La promotion de ce jour est terminée!',
}
