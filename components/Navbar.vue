      ...
      <div class="d-none d-md-block col-md-3">
        <div class="d-flex justify-content-end">
          <div class="position-relative d-flex">
            <!-- <div v-if="user">
              <div class="btn px-3 pb-0 pt-1 box">
            ...
            <div>
              <div
                class="btn px-3 pb-0 pt-1 box user-box"
              ...
              >
                ...
                <p v-if="user" class="mb-0 fs-14">
                  {{ user.customer.firstName }}
                </p>
                <p v-else class="mb-0 fs-14">Accedi</p>
              </div>
          ...
          <div class="position-relative" v-if="true">
            <div class="">
              <div
                v-if="1"
                class="btn px-3 pb-0 pt-1 box cart-box"
              ...
              >
                ...
                <div v-else class="btn px-3 pb-0 pt-1 box cart-box">
                  <svg
                    width="27px"
                    height="26px"
                    viewBox="0 0 27 26"
                  ...
                  <p class="mb-0 fs-14" style="position: relative; top: 1px">
                    Carrello
                  </p>
                </div>
              </div>
